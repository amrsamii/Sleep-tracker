...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val sleepTrackerViewModel =
            ViewModelProvider(
                this,
                Injection.provideSleepTrackerViewModelFactory(dataSource, application)
            )
        ...
        sleepTrackerViewModel.eventNavigateToSleepQuality.observe(this) { sleepNight ->
            sleepNight?.let {
                ...
                sleepTrackerViewModel.onNavigationToSleepQualityComplete()
            }
        }

        sleepTrackerViewModel.eventShowSnackbar.observe(this) { showSnackbar ->
            if (showSnackbar) {
                Snackbar.make(
