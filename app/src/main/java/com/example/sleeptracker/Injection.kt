...
import com.example.sleeptracker.sleepdetail.SleepDetailViewModelFactory
...
object Injection {
    ...
    fun provideSleepDetailViewModelFactory(
        sleepNightKey: Long,
        dataSource: SleepDatabaseDao
    ): ViewModelProvider.Factory {
        return SleepDetailViewModelFactory(sleepNightKey, dataSource)
    }
}